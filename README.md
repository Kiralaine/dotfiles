...
<details> 
  <summary>Why its looks like autogenerated Hyprland config?</summary>
    <h2>Its basic showcase for Newbies.Other Dots can be hard to install or use for newbies,So i creted Stellar Rice for newbies</h2> 
</details>
<details> 
  <summary>Do i continue work on Stellar rice?</summary>
   <h2>Difficult to say. I usually prefer DE for linux,because its more stable and easy to use and ***Stellar🌃*** is my first rice,I want continue work on Stellar cuz i liked the Hypr Ecosystem.</h2>
</details>
<details> 
  <summary>Future Plans</summary>
   <h2>I want add more utilites and write own programms for Hyprland compositor,i continue work with  Stellar on  KISS philosphy</h2>
</details>
